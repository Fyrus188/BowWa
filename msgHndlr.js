...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = "6285226087964"
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/IndraFajri64', donate)
            break
        case '!tts':
        ...
        case '!demote':
            ...
            break
        case '!join':
            //return client.reply(from, 'Jika ingin meng-invite bot ke group anda, silahkan izin ke wa.me/6285226087964', id)
